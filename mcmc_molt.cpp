/* ==============================================================
 Hurdle NB DLS Model - Multiplicative
 ============================================================== */
...
double mh_update_gamma_i_allT(const std::vector<arma::mat>& Y_list,
  ...
  double ll_old = loglik_gamma_i_allT(Y_list, D_list, W_list,
  ...
  double ll_new = loglik_gamma_i_allT(Y_list, D_list, W_list,
                                      alpha_vec, beta_vec, r_vec,
                                      gamma_vec, theta_vec,
                                      i_node, include_diagonal);
...
double mh_update_theta_j_allT(const std::vector<arma::mat>& Y_list,
  ...
  double ll_old = loglik_theta_j_allT(Y_list, D_list, W_list,
                                      alpha_vec, beta_vec, r_vec,
                                      gamma_vec, theta_vec,
  ...
  double ll_new = loglik_theta_j_allT(Y_list, D_list, W_list,
                                      alpha_vec, beta_vec, r_vec,
                                      gamma_vec, theta_vec,
                                      j_node, include_diagonal);
