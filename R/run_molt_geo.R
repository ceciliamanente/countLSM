# ==============================================================================
# ==============================================================================
# ================ Multiplicative + Geographical Distance Model ================
# ==============================================================================
# ==============================================================================
...
# PATHS 
# ---------------------------------------------------------------
cpp_path      <- "path/to/cpp/mcmc_molt_geo.cpp"
...
res_molt_geo <- mcmc_moltiplicativo_geo(
  Y_list_R = Y_list,
  X_list_R = X_list,
  W_list_R = W_list,  
...
saveRDS(res_molt_geo, file = file.path(output_dir_mcmc, "res_molt_geo.rds"))
...
alpha_samples <- res_molt_geo$alpha_samples
beta_samples  <- res_molt_geo$beta_samples
rho_samples   <- res_molt_geo$rho_samples
r_samples     <- res_molt_geo$r_samples
X_last        <- res_molt_geo$X_last
X_samples     <- res_molt_geo$X_samples
gamma_samples <- res_molt_geo$gamma_samples
theta_samples <- res_molt_geo$theta_samples
...
ppc_results_molt_geo <- ppc_all_years_MOLT_GEO(
  Y_list = Y_list,
  res = res_molt_geo,
  W_list = W_list,
  G = G,
...
# Save
saveRDS(ppc_results_molt_geo, file = file.path(output_dir_ppc, "ppc_results_molt_geo.rds"))
...
for (year in names(Y_list)) {
  ...
  # 1. Stats
  plot_ppc_stats(
    ppc_results = ppc_results_molt_geo,
    year_name = year,
    model = "molt"
  )
