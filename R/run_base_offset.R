# ==============================================================================
# ==============================================================================
# =================== Baseline + Exposure Adjustment Model =====================
# ==============================================================================
# ==============================================================================
...
# PATHS 
# ---------------------------------------------------------------
cpp_path        <- "path/to/cpp/mcmc_base_offset.cpp"
...
res_base_offset <- mcmc_base_offset(
  Y_list_R    = Y_list,
  X_list_R    = X_list,
  W_list_R    = W_list,
...
saveRDS(res_base_offset, file = file.path(output_dir_mcmc, "res_base_offset.rds"))
...
ppc_results_base_offset <- ppc_all_years_BASE_OFFSET2(
  Y_list    = Y_list,
  res       = res_base_offset,
  W_list    = W_list,
  logE_list = logE_list,
...
saveRDS(ppc_results_base_offset, file = file.path(output_dir_ppc, "ppc_results_base_offset.rds"))
...
for (year in names(Y_list)) {
  ...
  plot_ppc_stats(
    ppc_results = ppc_results_base_offset,
    year_name   = year,
    model       = "base"
  )
