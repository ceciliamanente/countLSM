# ==============================================================================
# ==============================================================================
# ========== Baseline + Geographical Distance + Exp.Adj. Term Model ============
# ==============================================================================
# ==============================================================================
...
# PATHS 
# ---------------------------------------------------------------
cpp_path        <- "path/to/cpp/mcmc_base_geo_offset.cpp"
...
res_base_geo_offset <- mcmc_base_geo_offset(
  Y_list_R = Y_list,
  X_list_R = X_list,
  W_list_R = W_list,
...
saveRDS(res_base_geo_offset, file = file.path(output_dir_mcmc, "res_base_geo_offset.rds"))

# ---------------------------------------------------------------
# 5). DIAGNOSTIC
# ---------------------------------------------------------------

res_base_geo_offset$DIC

alpha_samples <- res_base_geo_offset$alpha_samples
beta_samples <- res_base_geo_offset$beta_samples
rho_samples <- res_base_geo_offset$rho_samples
...
ppc_results_base_geo_offset <- ppc_all_years_BASE_GEO_OFFSET(
  Y_list = Y_list,
...
saveRDS(ppc_results_base_geo_offset, file = file.path(output_dir_ppc, "ppc_results_base_geo_offset.rds"))
...
for (year in names(Y_list)) {
  ...
  plot_ppc_stats(
    ppc_results = ppc_results_base_geo_offset,
    year_name = year,
    model = "base"
  )
